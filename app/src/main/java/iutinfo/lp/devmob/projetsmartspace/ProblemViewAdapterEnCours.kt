...
class ProblemViewAdapterEnCours(context: Context, problems: List<GetProblem>) : ArrayAdapter<GetProblem>(context, 0, problems) {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        problemView.populateEnCours(getItem(position))
        return problemView
    }
}